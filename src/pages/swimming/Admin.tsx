    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-2xl font-bold flex items-center">
          <Shield className="w-8 h-8 text-cyan-600 mr-2" />
          Swimming Admin Panel
        </h1>
        <button
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          ...
          <div className="space-y-4">
            <button className="w-full px-4 py-2 bg-cyan-100 text-cyan-800 rounded-lg hover:bg-cyan-200 transition-colors">
              Manage Officials
            </button>
            <button className="w-full px-4 py-2 bg-cyan-100 text-cyan-800 rounded-lg hover:bg-cyan-200 transition-colors">
              View Access Logs
      ...
      <div className="bg-white p-6 rounded-lg shadow-md">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <button className="p-4 border rounded-lg hover:bg-cyan-50 text-left transition-colors">
      ...
      <div className="bg-cyan-50 border border-cyan-200 rounded-lg p-6">
        <div className="flex items-center mb-2">
          ...
          <h2 className="text-lg font-semibold text-cyan-800">Security Notice</h2>
        </div>
